...
bot.onText(/\/start(?:\s+(.+))?/, async (msg, match) => {
  ...
  try {
    ...
    const introText = `👋 Добро пожаловать в *EagleZone*!
    
📲 Это кликер с бонусами за приглашения. Вот твой инвайт-код: \`${referralCode}\`
    
🔗 Поделись им с друзьями, чтобы получить +${INVITE_BONUS} EAGLE за каждого!
